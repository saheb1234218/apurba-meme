...
const addpost=()=>{
  axios.post("https://backend-xmemes.herokuapp.com/memes",{name: name,caption:caption,url:url}).then(()=>{
...
const editpost=(id,nam)=>{
  ...
  const new_name=nam;
axios.put("https://backend-xmemes.herokuapp.com/memes/${id}",{new_name: new_name,new_url: new_url,new_caption:new_caption, id: id}).then(()=>{
...
const deletepost=(id)=>{
  axios.delete("https://backend-xmemes.herokuapp.com/delete/${id}").then((req,res)=>{
...
useEffect(()=>{
axios.get("https://backend-xmemes.herokuapp.com/memes").then((response)=>{
